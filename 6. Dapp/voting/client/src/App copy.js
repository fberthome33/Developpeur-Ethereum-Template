...
function App() {
  ...
  useEffect(() => {
    (async function () {
      try {
        ...
        setState({ owner: owner, workflowStatus: workflowStatus,  web3: web3, accounts: accounts, contract: instance });
  ...
  return (
    <div className="App">
      ...
      <div>The stored value is: {state.owner}</div>
      <div>The workflowStatus value is: {state.workflowStatus}</div>
